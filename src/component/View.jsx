...
let endpoint = 'https://anonymous-backend-o0f2.onrender.com/user/view'
    ...
    // let endpoint2 = 'http://localhost:4000/user/delete'
let endpoint2 = 'https://anonymous-backend-o0f2.onrender.com/user/delete'
  ...
  return (
       ...
       <div className='lg:mb-[10px] mb-[50px] md:mb-[200%] mb-[200%] p-2 text-white lg:mt-0 md:mt-0  lg:gap-20 gap-2 '>
       <h1 className='font-serif font-bold text-4xl text-center'>My Answers</h1>
       <p className='font-serif'>Scroll down to check out the messages that you have received 👇👇</p>
       { message.length == 0 ? 'Oops! No one has sent you a message' :
       
         message.map((item, i)=>(
             <div className='font-serif py-2 px-2 text-center border rounded mb-5' key={i}>
