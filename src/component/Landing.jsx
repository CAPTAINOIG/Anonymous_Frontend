  ...
  return (
    ...
    <Navbar/>
       <div className='background' >
            <div style={mySection} className='bg-blue-950 lg:py-10   text-center flex flex-col justify-center items-center rounded-xl lg:px-4 px-2 lg:w-1/3 md:w-1/2 w-[90%]'>
